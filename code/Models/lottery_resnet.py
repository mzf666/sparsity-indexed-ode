...
def mobilenet_v2(input_shape, num_classes, dense_classifier=False, pretrained=False):
    from Models.CifarTeachers.mobilenetv2 import mobile_half
    return mobile_half(num_classes)
